...
function LandingPage() {
  return (
      <section className="bg-white dark:bg-gray-900 bg-cover h-full" style={{ backgroundImage: "url('/asset/arlington-research-kN_kViDchA0-unsplash.jpg')" }}>
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 bg-secondary-color/75 ">
