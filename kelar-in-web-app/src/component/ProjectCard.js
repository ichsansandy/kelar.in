...
function ProjectCard({ project, isYourProject }) {
  ...
  return (
    <div
      ...
      className={
        "group scroll-ml-6 snap-start min-h-full animate-hover  bg-third-color hover:bg-secondary-color mx-4 rounded-3xl shadow-xl  min-w-200 flex flex-col justify-center items-center cursor-pointer "
