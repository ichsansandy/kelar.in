...
export default function UpdateTask({ setTasks, tasks, projectDueDate }) {
  const { id } = useParams();
  ...
  return (
    <>
      <button
        className="absolute  left-0 -top-[1.1px] w-10 h-full bg-fourth-color text-white hover:bg-primary-color/75 group font-bold uppercase text-sm px-6 py-3 rounded shadow outline-none focus:outline-none ease-linear transition-all duration-150"
        type="button"
