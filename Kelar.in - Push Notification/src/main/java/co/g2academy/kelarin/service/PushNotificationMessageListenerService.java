...
import co.g2academy.kelarin.repository.PushNotificationRepository;
 ...
 */
@Service
public class PushNotificationMessageListenerService implements MessageListener{
    @Autowired
    ...
    public void onMessage(Message message, byte[] pattern) {
        try {
            ...
            PushNotification pushNotification = mapper.readValue(json, new TypeReference<PushNotification>(){});
